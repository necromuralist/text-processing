...
project = u'Text Processing Notes'
copyright = u'2018, cloistered monkey'
...
latex_documents = [
  ('index', basename + '.tex', basename + u' Documentation',
   u'russelln', 'manual'),
]
